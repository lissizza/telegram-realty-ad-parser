...
async def init_database():
    ...
    try:
        ...
        await db.real_estate_ads.create_index("price_amd")
        await db.real_estate_ads.create_index("district")
        await db.real_estate_ads.create_index("created_at")
        await db.real_estate_ads.create_index([("property_type", 1), ("price_amd", 1)])
    ...
    try:
        ...
        if filter_count == 0:
            sample_filter = {
                ...
                "min_rooms": 2,
                "max_rooms": 3,
                "min_price_amd": 100000,
                "max_price_amd": 500000,
